...
public interface ImageMapper extends BaseMapper<Image> {
    ...
    IPage<Image> listImageInfosByPage(Page<Image> pageInfo, @Param(value = "imageSearchParam") ImageSearchParam imageSearchParam , @Param("adminLevel") String adminLevel);
}
