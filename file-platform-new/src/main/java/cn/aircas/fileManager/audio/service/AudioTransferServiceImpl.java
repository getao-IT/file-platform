...
//        }
    ...
    public AudioInfo parseFileInfo(String filePath) {
        ...
        try {
            ...
            String audioDuration = String.format("%d分%d秒",(audioHeader.getTrackLength())/60,(audioHeader.getTrackLength()));
            ...
            audioInfo.setFormat(audioHeader.getFormat());
            audioInfo.setDuration(audioHeader.getTrackLength());
